...
class XYZTab(QWidget):
    def __init__(self, parent=None):
        ...
        self.nlines = QSpinBox(); self.nlines.setRange(100, 5_000_000); self.nlines.setValue(20000)
        self.pxmin = QSpinBox(); self.pxmin.setRange(1, 500); self.pxmin.setValue(1)
        self.binw = QSpinBox(); self.binw.setRange(1, 50); self.binw.setValue(1)
        self.xmax = QSpinBox(); self.xmax.setRange(1, 100000); self.xmax.setValue(150)
        self.logy = QCheckBox("Axe Y en log"); self.logy.setChecked(True)
    ...
    def run_xyz(self):
        ...
        try:
            ...
            with contextlib.redirect_stdout(buf):
                ...
                lens_noire = cld_3d_from_volume(vol_noire, n_lines=N_LINES, px_min=PX_MIN, seed=1, step_vox=STEP)
                lens_blanche = cld_3d_from_volume(vol_blanche, n_lines=N_LINES, px_min=PX_MIN, seed=2, step_vox=STEP)
